<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/Common.Master" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="UI.Views.DomesticConsumer.NoticeList" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 10%">
                                        ...
                                        <a href="NoticeUI.aspx?id=<%# Eval("Id")%>" class="btn btn-warning">查看</a>
