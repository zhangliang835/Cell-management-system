<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/Common.Master" AutoEventWireup="true" CodeBehind="ShenDu.aspx.cs" Inherits="UI.Views.ShangmenfuwuUI.ShenDu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="overflow-y: auto; max-height: 93vh;">
        <div class="daobo">
            ...
            <div class="anniu">
                <a href="ShenDu.aspx"><i class="fa-solid fa-droplet"></i>&nbsp;&nbsp;深度清洁</a>
            </div>
            <div class="anniu">
       ...
       <div  class="aa">深度保洁3小时</div>
       <div class="jiage">￥169</div>
   </div>
                <div class="xuanxiang2">

                    <div  class="aa">深度保洁4小时</div>
                    <div class="jiage">￥269</div>
                </div>
                <div class="xuanxiang2">

                    <div  class="aa">深度保洁5小时</div>
                    <div class="jiage">￥369</div>
                </div>
                <div class="xuanxiang2">

                    <div  class="aa">深度保洁6小时</div>
                    <div class="jiage">￥469</div>
                </div>
                <div class="xuanxiang2">

                    <div  class="aa">深度保洁7小时</div>
                    <div class="jiage">￥569</div>
                </div>
                <div class="xuanxiang2">

                    <div  class="aa">深度保洁8小时</div>
                    <div class="jiage">￥669</div>
                </div>
        ...
        <div class="mowei">
            ...
            <div class="ziti">
                <label>服务项目：深度保洁</label>
            </div>
            <div class="ziti">
                <label>服务内容：表面除尘、厨房除油污、卫生间爱你洗手台除水垢、柜内清洁、物品整理</label>
            </div>
            <div class="ziti">
            ...
            <div class="ziti">
                <label>
                    为保证服务质量，本服务不适用于以下场景:学校/办公室/商铺/新居开荒
                </label>
                <br />
                  <div style="color: red; font-weight: 800; font-size: 12px;">深度保洁不包含以下服务:</div>
                ...
                3.天花板及灯具清洗
                            <br />
                4.窗帘，地毯，地板打蜡，家具保养等家居洗护和绿植养护5.部分城市实行垃圾分类，非垃圾投放时间段无法帮忙处理垃圾，请谅解
