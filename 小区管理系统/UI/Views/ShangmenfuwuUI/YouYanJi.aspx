<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/Common.Master" AutoEventWireup="true" CodeBehind="YouYanJi.aspx.cs" Inherits="UI.Views.ShangmenfuwuUI.YouYanJi" %>
        ...
        <div style="background-color: white; padding-top: 20px; margin-top: 20px;">
            ...
            <div class="xuanxiang">
                <div class="xuanxiang2">
                    <div class="aa">油烟机免拆洗</div>
                    <div class="jiage">￥139</div>
                </div>
                <div class="xuanxiang2">

                    <div  class="aa">油烟机拆洗</div>
                    <div class="jiage">169</div>
                </div>
                <div class="xuanxiang2">
                    <div  class="aa">油烟机拆洗+灶台清洗</div>
                    <div class="jiage">￥189</div>
                </div>
...
、油烟机拆洗+灶台清洗
            ...
            <div style="margin-top: 30px;">
             ...
             <div class="ziti">
            预计每台油烟机清洗时长不低于60分钟，因各种油烟机机型差异以及服务场景差异，以实际服务时长为准
             </div>
            <div style="margin-top: 30px;">
                <label>服务退款规则</label>
            </div>
