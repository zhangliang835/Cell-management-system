<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/Common.Master" AutoEventWireup="true" CodeBehind="RiChang.aspx.cs" Inherits="UI.Views.ShangmenfuwuUI.RiChang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="background-color: white; padding-top: 20px; margin-top: 20px;">
            ...
            <div class="xuanxiang">
                <div class="xuanxiang2">
                    <div class="aa">日常清洁2小时</div>
                    <div class="jiage">￥50</div>
                </div>
                <div class="xuanxiang2">

                    <div  class="aa">日常清洁3小时</div>
                    <div class="jiage">￥100</div>
                </div>
                <div class="xuanxiang2">
                    <div  class="aa">日常清洁4小时</div>
                    <div class="jiage">￥150</div>
                </div>
        ...
        <div class="mowei">
            ...
            <div class="ziti">
                <label>服务项目：日常清洁</label>
            </div>
            <div class="ziti">
                <label>服务内容：表面除尘（不含除胶、除油污水垢）表面物品整理（桌面、床铺）洗碗、日常垃圾清理
                </label>
            </div>
            <div class="ziti">
                <label>服务范围：厨房、卫生间、客厅、卧室、餐厅、阳台</label>
            </div>
            ...
            <div class="ziti">
                <label>
                    日常保洁不适用于以下场景:办公室/商铺/学校/集体宿舍/民宿/租房新入住/3个月以上未入住房屋/新居开荒
                </label>
                <br />
                  <div style="color: red; font-weight: 800; font-size: 12px;">日常清洁不包含以下服务:</div>
          
                1.擦玻璃、玻璃隔断/墙、陈年污垢清洁、家电清洗、家具除螨/护理/清洗、地板打蜡、灯具清洁、登高清洁、物品收纳(如叠衣服、整理衣柜等)、收拾玩具、洗衣/洗鞋、做饭、接送孩子等家务劳动
                <br />
                2.柜子内部及内部陈设物品、窗帘、工艺品、玉器、古董字画、宗教陈设、花草绿植、天花板及附属品（如吊灯等）清洁及绿植养护
                            <br />
                3.厨卫重水垢和重油污清洁，如有需要请选择“厨卫深度保洁”服务
                            <br />
                4.养宠物家庭保洁，如有需要请选择“养宠家庭保洁”服务。鱼缸无论大小，只做表面擦拭除尘，不做任何专业清洁处理（如换水、换鱼、喂鱼等)
            ...
            <div style="margin-top: 30px;">
             ...
             <div class="ziti">
              服务时长最低2小时起，服务时长不足2小时按照2小时计费;服务时长超出2小时且不超15分钟按照2小时计费;服务时长超出2小时且超出15-60分钟按照3小时计费
             </div>
            <div style="margin-top: 30px;">
                <label>服务退款规则</label>
            </div>
