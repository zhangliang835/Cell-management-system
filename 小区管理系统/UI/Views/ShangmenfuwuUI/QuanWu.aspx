<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/Common.Master" AutoEventWireup="true" CodeBehind="QuanWu.aspx.cs" Inherits="UI.Views.ShangmenfuwuUI.QuanWu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="anniu">
   <a href="BingXiang.aspx"><i class="fa-solid fa-icicles"></i>&nbsp;&nbsp;冰箱清洗</a>       </div>
       <div class="anniu">
   ...
   <div style="background-color: white; padding-top: 20px; margin-top: 20px;">
       ...
       <div class="xuanxiang">
           <div class="xuanxiang2">
               <div class="aa">全屋大扫除5小时</div>
               <div class="jiage">￥350 </div>
           </div>
           <div class="xuanxiang2">

               <div  class="aa">全屋大扫除6小时</div>
               <div class="jiage">￥400</div>
           </div>
           <div class="xuanxiang2">

               <div  class="aa">全屋大扫除8小时</div>
               <div class="jiage">￥500</div>
           </div>
           <div class="xuanxiang2">

               <div  class="aa">全屋大扫除10小时</div>
               <div class="jiage">￥600</div>
           </div>
           <div class="xuanxiang2">

               <div  class="aa">全屋大扫除12小时</div>
               <div class="jiage">￥750</div>
           </div>
        ...
        <div class="mowei">
            ...
            <div class="ziti">
                <label>服务项目：全屋大扫除</label>
            </div>
            <div class="ziti">
                <label>服务内容：表面除尘、厨房除油污、卫生间除水垢、柜内清洁、双面精细擦窗、厨卫高温消毒、物品整理
                </label>
            </div>
            <div class="ziti">
            ...
            <div class="ziti">
                <label>
                  表面除尘、厨房除油污、卫生间除水垢、柜内清洁、双面精细擦窗、厨卫高温消毒、物品整理
                </label>
                <br />
                  <div style="color: red; font-weight: 800; font-size: 12px;">全屋大扫除不包含以下服务:</div>
