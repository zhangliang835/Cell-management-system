<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master/Master.Master" AutoEventWireup="true" CodeBehind="StaffSignin.aspx.cs" Inherits="UI.Views.staff.StaffSignin" %>
...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
          ...
          <asp:TextBox ID="Age" type="text" class="form-control custom-textbox" runat="server"></asp:TextBox>
          <!-- 姓名验证 -->
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="sex">部门</label>
            <select id="Department" class="form-control custom-textbox" runat="server">
    ...
    <div class="col-sm-5">
        <div class="form-group">
            <label class="control-label">照片选择</label>
        ...
        <div class="form-group">
            <label class="control-label ">照片预览</label>
